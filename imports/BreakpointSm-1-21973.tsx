import svgPaths from "./svg-d26a2j582o";
...
function Frame1000003757() {
  return (
    <div className="absolute h-[324px] left-[420px] top-16 w-[497px]">
...
export default function BreakpointSm() {
  return (
    ...
    >
      <div
        className="absolute bg-center bg-cover bg-no-repeat bottom-0 left-0 right-[64.504%] top-0"
        data-name="image 390"
